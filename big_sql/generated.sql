-- 数据质量稽核 - 批量SQL查询
-- 生成时间: 2026-01-21 18:38:45
-- 时间范围: 2026-01-12 00:00:00 ~ 2026-01-19 00:00:00

-- log_id - uniqueness_check - 统计查询
...
-- operate_source - enum_check - 统计查询
-- 枚举值核查 - 统计版本（按设备类型分组）
-- 统计每个设备类型的枚举值分布
WITH 
-- 1. 定义时间范围
...
-- operate_source - enum_check - 样例查询
-- 枚举值核查 - 样例版本
-- 返回最多10个不同的枚举值样例供人工检查
WITH 
-- 1. 定义时间范围
...
-- operate_source - null_check - 统计查询
-- 非空核查 - 统计版本（按设备类型分组）
-- 统计每个设备类型的空值记录数量和比例
WITH 
-- 1. 定义时间范围
...
-- operate_source - null_check - 样例查询
-- 非空核查 - 样例版本（只查log_id，不查generic_raw_log）
-- 返回一个空值记录的log_id和设备类型
WITH 
-- 1. 定义时间范围
...
-- natural_org_path - null_check - 统计查询
-- 非空核查 - 统计版本（按设备类型分组）
-- 统计每个设备类型的空值记录数量和比例
WITH 
-- 1. 定义时间范围
...
-- natural_org_path - null_check - 样例查询
-- 非空核查 - 样例版本（只查log_id，不查generic_raw_log）
-- 返回一个空值记录的log_id和设备类型
WITH 
-- 1. 定义时间范围
...
-- natural_status - null_check - 统计查询
-- 非空核查 - 统计版本（按设备类型分组）
-- 统计每个设备类型的空值记录数量和比例
WITH 
-- 1. 定义时间范围
...
-- natural_status - null_check - 样例查询
-- 非空核查 - 样例版本（只查log_id，不查generic_raw_log）
-- 返回一个空值记录的log_id和设备类型
WITH 
-- 1. 定义时间范围
...
-- natural_status - enum_check - 统计查询
-- 枚举值核查 - 统计版本（按设备类型分组）
-- 统计每个设备类型的枚举值分布
WITH 
-- 1. 定义时间范围
...
-- natural_status - enum_check - 样例查询
-- 枚举值核查 - 样例版本
-- 返回最多10个不同的枚举值样例供人工检查
WITH 
-- 1. 定义时间范围
...
-- account_status - enum_check - 统计查询
-- 枚举值核查 - 统计版本（按设备类型分组）
-- 统计每个设备类型的枚举值分布
WITH 
-- 1. 定义时间范围
...
-- account_status - enum_check - 样例查询
-- 枚举值核查 - 样例版本
-- 返回最多10个不同的枚举值样例供人工检查
WITH 
-- 1. 定义时间范围
...
-- account_status - null_check - 统计查询
-- 非空核查 - 统计版本（按设备类型分组）
-- 统计每个设备类型的空值记录数量和比例
WITH 
-- 1. 定义时间范围
...
-- account_status - null_check - 样例查询
-- 非空核查 - 样例版本（只查log_id，不查generic_raw_log）
-- 返回一个空值记录的log_id和设备类型
WITH 
-- 1. 定义时间范围
...
-- person_liable - conditional_null_check - 统计查询
-- 条件非空核查 - 统计版本（按设备类型分组）
...
-- person_liable - conditional_null_check - 样例查询
...
-- from_account - conditional_null_check - 统计查询
-- 条件非空核查 - 统计版本（按设备类型分组）
-- 统计每个设备类型在特定条件下为空的记录数量和比例
WITH 
-- 1. 定义时间范围
...
-- from_account - conditional_null_check - 样例查询
-- 条件非空核查 - 样例版本（只查log_id）
-- 返回一个在特定条件下为空的样例log_id
WITH 
-- 1. 定义时间范围
...
-- from_account_status - enum_check - 统计查询
-- 枚举值核查 - 统计版本（按设备类型分组）
-- 统计每个设备类型的枚举值分布
WITH 
-- 1. 定义时间范围
...
-- from_account_status - enum_check - 样例查询
-- 枚举值核查 - 样例版本
-- 返回最多10个不同的枚举值样例供人工检查
WITH 
-- 1. 定义时间范围
...
-- from_account_status - conditional_null_check - 统计查询
-- 条件非空核查 - 统计版本（按设备类型分组）
-- 统计每个设备类型在特定条件下为空的记录数量和比例
WITH 
-- 1. 定义时间范围
...
-- from_account_status - conditional_null_check - 样例查询
-- 条件非空核查 - 样例版本（只查log_id）
-- 返回一个在特定条件下为空的样例log_id
WITH 
-- 1. 定义时间范围
...
-- from_account_status - locked_accounts - 样例查询
-- 账号加锁统计 - 样例查询
-- 抽取加锁账号样例
WITH 
-- 定义时间范围
...
-- from_account_type - enum_check - 统计查询
-- 枚举值核查 - 统计版本（按设备类型分组）
-- 统计每个设备类型的枚举值分布
WITH 
-- 1. 定义时间范围
...
-- from_account_type - enum_check - 样例查询
-- 枚举值核查 - 样例版本
-- 返回最多10个不同的枚举值样例供人工检查
WITH 
-- 1. 定义时间范围
...
-- from_account_type - conditional_null_check - 统计查询
-- 条件非空核查 - 统计版本（按设备类型分组）
-- 统计每个设备类型在特定条件下为空的记录数量和比例
WITH 
-- 1. 定义时间范围
...
-- from_account_type - conditional_null_check - 样例查询
-- 条件非空核查 - 样例版本（只查log_id）
-- 返回一个在特定条件下为空的样例log_id
WITH 
-- 1. 定义时间范围
...
-- operate_time - time_null_check - 统计查询
...
-- operate_time - time_null_check - 样例查询
...
-- collect_time - time_null_check - 统计查询
-- 时间字段非空核查 - 统计版本（按设备类型分组）
-- 统计每个设备类型的时间字段空值情况
WITH 
-- 1. 定义时间范围
...
-- collect_time - time_null_check - 样例查询
-- 时间字段非空核查 - 样例版本（只查log_id）
-- 返回一个时间字段为空的样例log_id
WITH 
-- 1. 定义时间范围
...
-- database_service - correctness_check - 统计查询
-- 正确性核查 - 统计查询
-- 检查字段值是否在预期范围内
WITH 
-- 定义时间范围
...
-- dst_device_type - enum_check - 统计查询
-- 枚举值核查 - 统计版本（按设备类型分组）
-- 统计每个设备类型的枚举值分布
WITH 
-- 1. 定义时间范围
...
-- dst_device_type - enum_check - 样例查询
-- 枚举值核查 - 样例版本
-- 返回最多10个不同的枚举值样例供人工检查
WITH 
-- 1. 定义时间范围
...
-- dst_device_type - null_check - 统计查询
-- 非空核查 - 统计版本（按设备类型分组）
-- 统计每个设备类型的空值记录数量和比例
WITH 
-- 1. 定义时间范围
...
-- dst_device_type - null_check - 样例查询
-- 非空核查 - 样例版本（只查log_id，不查generic_raw_log）
-- 返回一个空值记录的log_id和设备类型
WITH 
-- 1. 定义时间范围
...
-- protocol - conditional_null_check - 统计查询
-- 条件非空核查 - 统计版本（按设备类型分组）
-- 统计每个设备类型在特定条件下为空的记录数量和比例
WITH 
-- 1. 定义时间范围
...
-- protocol - conditional_null_check - 样例查询
-- 条件非空核查 - 样例版本（只查log_id）
-- 返回一个在特定条件下为空的样例log_id
WITH 
-- 1. 定义时间范围
...
-- operate_name - semantic_check - 统计查询
-- 语义抽查 - 统计查询
-- 检查字段是否包含乱码、特殊字符等异常值
WITH 
-- 定义时间范围
...
-- operate_name - semantic_check - 样例查询
-- 语义抽查 - 样例查询
-- 优先返回包含异常字符的样例，如果没有则随机抽取10个不同的值进行人工检查
WITH 
-- 定义时间范围
...
-- operate_command - null_check - 统计查询
-- 非空核查 - 统计版本（按设备类型分组）
-- 统计每个设备类型的空值记录数量和比例
WITH 
-- 1. 定义时间范围
...
-- operate_command - null_check - 样例查询
-- 非空核查 - 样例版本（只查log_id，不查generic_raw_log）
-- 返回一个空值记录的log_id和设备类型
WITH 
-- 1. 定义时间范围
...
-- operate_command - semantic_check - 统计查询
-- 语义抽查 - 统计查询
-- 检查字段是否包含乱码、特殊字符等异常值
WITH 
-- 定义时间范围
...
-- operate_command - semantic_check - 样例查询
-- 语义抽查 - 样例查询
-- 优先返回包含异常字符的样例，如果没有则随机抽取10个不同的值进行人工检查
WITH 
-- 定义时间范围
...
-- operate_content - null_check - 统计查询
-- 非空核查 - 统计版本（按设备类型分组）
-- 统计每个设备类型的空值记录数量和比例
WITH 
-- 1. 定义时间范围
...
-- operate_content - null_check - 样例查询
-- 非空核查 - 样例版本（只查log_id，不查generic_raw_log）
-- 返回一个空值记录的log_id和设备类型
WITH 
-- 1. 定义时间范围
...
-- operate_content - semantic_check - 统计查询
-- 语义抽查 - 统计查询
-- 检查字段是否包含乱码、特殊字符等异常值
WITH 
-- 定义时间范围
...
-- operate_content - semantic_check - 样例查询
-- 语义抽查 - 样例查询
-- 优先返回包含异常字符的样例，如果没有则随机抽取10个不同的值进行人工检查
WITH 
-- 定义时间范围
...
-- gold_grant_result - statistical_analysis - 统计查询
-- 统计分析 - 统计查询
-- 对字段进行统计分析
WITH 
-- 定义时间范围
...
-- gold_grant_result - statistical_analysis - 样例查询
-- 统计分析 - 样例查询
-- 抽取代表性样例
WITH 
-- 定义时间范围
